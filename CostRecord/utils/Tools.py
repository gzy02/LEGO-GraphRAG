...
class Tools:
    ...
    path_id2name = "/raid/gzy/dataset/id2name.txt"
    path_id2name_pkl = "/raid/gzy/dataset/id2name.pkl"
    path_name2id_pkl = "/raid/gzy/dataset/name2id.pkl"
    path_kg = "/raid/gzy/dataset/rel_filter.txt"
    path_kg_pkl = "/raid/gzy/dataset/rel_filter_name.pkl"
