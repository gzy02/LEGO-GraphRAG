...
import time
openai.api_key = "VLLM"
openai.api_base = "http://localhost:11436/v1"
...
if hop == 1:
    question_data = 'data/CWQ/test.jsonl'
    save_file = 'data/CWQ/test_onehop.jsonl'
if hop == 2:
    question_data = 'data/CWQ/test.jsonl'
    save_file = 'data/CWQ/test_twohop.jsonl'
...
model_name = 'llama3-8b'  # "gpt-3.5-turbo-0125"  #
model_path = {
    ...
    for _ in range(3):
        try:
            response = openai.ChatCompletion.create(
                ...
                max_tokens=min(max_tokens, output_tokens),
                temperature=0.2,
                top_p=0.1,
                timeout=30
            )
