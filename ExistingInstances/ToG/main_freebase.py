...
if __name__ == '__main__':
    ...
    parser.add_argument("--LLM_name", type=str,
                        default="llama3-8b", help="base LLM model.")  # meta-llama/
    parser.add_argument("--LLM_type", type=str,
                        default="meta-llama/Meta-Llama-3-8B-Instruct", help="base LLM model.")  # meta-llama/Meta-Llama-3-8B-Instruct, llama2:7b-chat-q5_K_M
